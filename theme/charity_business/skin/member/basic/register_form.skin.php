...
<div class="btn_confirm">
    <a href="<?php echo G5_URL ?>" class="btn btn-large btn-theme btn-rounded">취소</a>
    <input type="submit" value="<?php echo $w==''?'회원가입':'정보수정'; ?>" id="btn_submit" class="btn btn-large btn-theme btn-rounded" accesskey="s">
</div>
</form>
