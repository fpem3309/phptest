...
<div>
    ...
    <section id="fregister_term">
        ...
        <textarea rows="12" class="input-block-level" readonly><?php echo get_text($config['cf_stipulation']) ?></textarea>
    ...
    <div class="btn_confirm">
        <input type="submit" class="btn btn-large btn-theme btn-rounded" value="회원가입">
    </div>
