              ...
              <div class="row">
                <div class="span12">
                  <div class="post-image">
                    <div class="post-heading">
                      <h3><?php if ($is_checkbox) { ?>
                            ...
                            <?php echo utf8_strcut(strip_tags($list[$i]['subject']), 40, '..'); ?>                    
                         </a></h3>
                    </div>
                  ...
                  <div class="bottom-article">
                    <ul class="meta-post">
                      <li><i class="icon-calendar"></i><a href="#"> <?php echo $list[$i]['datetime2'] ?></a></li>
                      <li><i class="icon-user"></i><a href="#"> <?php echo $list[$i]['name'] ?></a></li>
                      <li><i class="icon-eye-open"></i><a href="#"> <?php echo $list[$i]['wr_hit'] ?></a></li>
                      <li><i class="icon-comments"></i><a href="#"><?php echo $list[$i]['wr_comment']; ?></a></li>
                    </ul>
                    <a href="<?php echo $list[$i]['href'] ?>" class="pull-right">자세히보기 <i class="icon-angle-right"></i></a>
                  </div>
                </div>
              </div>
            </article>
